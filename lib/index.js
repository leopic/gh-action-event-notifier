...
module.exports.getFallbackBlocks = (jobStatus, payload, _) => {
...
module.exports.getBlockBuilder = (eventName, jobStatus, payload, runId) => {
  switch (eventName) {
    ...
    default:
      return this.getFallbackBlocks(jobStatus, payload, runId);
  }
};
...
module.exports.run = () => {
  try {
    ...
    const blocks = this.getBlockBuilder(github.context.eventName, jobStatus, payload, runId);
